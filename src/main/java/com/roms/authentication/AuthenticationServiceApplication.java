...
public class AuthenticationServiceApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		userRepository.save(new User("sham", passwordEncoder.encode("kumar"), "ROLE_USER"));
		userRepository.save(new User("karna", passwordEncoder.encode("vijay"), "ROLE_USER"));
		userRepository.save(new User("ironman", passwordEncoder.encode("stark"), "ROLE_USER"));
		userRepository.save(new User("alita", passwordEncoder.encode("battleangel"), "ROLE_USER"));
	}
}
